  ...
  return (
    <PublicContainer>
      ...
      <p>
        ...
        of My Company Name's Website, located at Website.com.
      </p>
      ...
      <p>
        ...
        use cookies in agreement with the My Company Name's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, My Company Name and/or its licensors own the
      ...
      <p>
        ...
        opinions of My Company Name,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, My Company Name
      ...
      <p>
        My Company Name reserves the right to monitor all Comments and to remove
      ...
      <ul>
        ...
        <li>
          ...
          without limitation copyright,
        </li>
        <li>
          patent or trademark of any third party; The Comments do not contain
          any defamatory, libelous, offensive, indecent or otherwise unlawful
      ...
      <p>
        You hereby grant My Company Name a non-exclusive license to use,
